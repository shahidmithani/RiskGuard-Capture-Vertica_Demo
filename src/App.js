...
function App() {
  ...
  async function getAuthToken() {
    ...
    console.log('username: ', properties.username)
  ...
  function displayPiiData() {
    ...
    if (tmeResults.length === 0) {
      ...
      setPiiData(tmeResults.map(extractedTerm => {
        ...
        else if (extractedTerm.nfinderNormalized)
          pii += `${extractedTerm.cartridgeID} = ${extractedTerm.nfinderNormalized}\n`
  ...
  return (
      <main>
        ...
        <div className="ot2-body">
          ...
          <div>
            <h3>2. Use Risk Guard Service to extract PII data from a document (PDF)</h3>
          ...
          <div>
            <h3>3. Use Capture Service for full data extraction from a document image (TIF)</h3>
